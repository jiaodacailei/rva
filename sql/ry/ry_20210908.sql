...
(
    ...
    `ding_id`       varchar(100) DEFAULT NULL COMMENT '钉钉ID',
    `ding_union_id` varchar(100) DEFAULT NULL COMMENT '钉钉UnionId',
    `wx_open_id`    varchar(100) DEFAULT NULL COMMENT '微信OpenId',
    `wx_union_id`   varchar(100) DEFAULT NULL COMMENT '微信UnionId',
    PRIMARY KEY (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户信息表';
...
INSERT INTO `sys_user`(`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `email`, `phonenumber`, `sex`,
                       ...
                       `update_by`, `update_time`, `remark`, `qq`, `wx`, `id_card`, `ding_id`, `ding_union_id`,
                       `wx_open_id`, `wx_union_id`)
VALUES (1, '100', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2022-05-18 20:06:28',
        'admin', '2022-04-21 16:03:31', '', '2022-05-18 20:06:28', '管理员', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user`(`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `email`, `phonenumber`, `sex`,
                       `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`,
                       `update_by`, `update_time`, `remark`, `qq`, `wx`, `id_card`, `ding_id`, `ding_union_id`,
                       `wx_open_id`, `wx_union_id`)
VALUES (2, '105', 'ry', '若依', '00', 'ry@qq.com', '15666666666', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2022-04-21 16:03:31',
        'admin', '2022-04-21 16:03:31', '', NULL, '测试员', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_role`(`role_id`, `role_name`, `role_key`, `role_sort`, `data_scope`, `menu_check_strictly`,
                       ...
                       `update_time`, `remark`, `property_blacklist`)
VALUES (1, '超级管理员', 'admin', 1, '1', 1, 1, '0', '0', 'admin', '2022-04-21 16:03:32', '', NULL, '超级管理员', NULL);
INSERT INTO `sys_role`(`role_id`, `role_name`, `role_key`, `role_sort`, `data_scope`, `menu_check_strictly`,
                       `dept_check_strictly`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`,
                       `update_time`, `remark`, `property_blacklist`)
VALUES (2, '普通角色', 'common', 2, '2', 1, 1, '0', '0', 'admin', '2022-04-21 16:03:32', '', NULL, '普通角色', NULL);
...
insert into sys_config
values (2, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'Y', 'admin', sysdate(), '', null, '初始化密码 123456', null);
insert into sys_config
...
-- 20、角色信息表_KPI项
-- ----------------------------
drop table if exists sys_role_kpi_item_68ff;
CREATE TABLE `sys_role_kpi_item_68ff`
(
    `jiaosexinxibiao_167a` varchar(20)  NOT NULL COMMENT '角色信息表',
    `kpixiang_153d`        varchar(100) NOT NULL COMMENT 'KPI项',
    PRIMARY KEY (`jiaosexinxibiao_167a`, `kpixiang_153d`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色信息表_KPI项';

-- ----------------------------
-- 21、角色信息表_应用项
-- ----------------------------
drop table if exists sys_role_appitem_a4e7;
CREATE TABLE `sys_role_appitem_a4e7`
(
    `jiaosexinxibiao_5877` varchar(20) NOT NULL COMMENT '角色信息表',
    `yingyongxiang_cd34`   varchar(64) NOT NULL COMMENT '应用项',
    PRIMARY KEY (`jiaosexinxibiao_5877`, `yingyongxiang_cd34`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色信息表_应用项';

-- ----------------------------
-- 22、角色信息表_应用
-- ----------------------------
drop table if exists sys_role_app_c4c1;
CREATE TABLE `sys_role_app_c4c1`
(
    `jiaosexinxibiao_9a37` varchar(20) NOT NULL COMMENT '角色信息表',
    `yingyong_6de5`        varchar(64) NOT NULL COMMENT '应用',
    PRIMARY KEY (`jiaosexinxibiao_9a37`, `yingyong_6de5`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色信息表_应用';

-- ----------------------------
-- 23、部门增加类型
-- ----------------------------
alter table sys_dept add type varchar(20) COMMENT '类型';

-- ----------------------------
-- 24、所有表上增加 rva_update_time_
-- ----------------------------
alter table gen_table add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table gen_table_column add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';

alter table sys_config add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_dept add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_dict_data add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_dict_type add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_job add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_job_log add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_logininfor add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_menu add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_notice add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_oper_log add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_post add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_role add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_role_appitem_a4e7 add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_role_app_c4c1 add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_role_dept add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_role_kpi_item_68ff add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_role_menu add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_user add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_user_post add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';
alter table sys_user_role add `rva_update_time_` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '时间戳';